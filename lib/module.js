...
const NativeModule = require('native_module'); // bootstrap_node.js 的 NativeModule
...
Module._load = function(request, parent, isMain) {
  ...
  /**
   * 是否是内部的js模块
   * 如果是内部js模块，调用 NativeModule.require(filename) 进行加载
   * 没有 --expose[-_]internals 启动参数，lib/internal 目录下的内部js模块不允许调用
   */
